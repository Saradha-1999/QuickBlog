  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-10'>
            ...
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>Create your own blog in minutes. No need for filters, just shout and write what you think aloud. Your story starts here </p>
